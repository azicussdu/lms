...
//                return Route('students.show', $this->slug);
    ...
    public function image()
    {
        if (Schema::hasColumn($this->getTable(), 'image')) {
            return asset(!empty($this->image) ? '/assets/' . $this->getTable() . '/images/' . $this->image : \constPath::DefaultImage);
        }
    }
    ...
    {
        if (Schema::hasColumn($this->getTable(), 'image')) {
            return asset(!empty($this->image) ? '/assets/' . $this->getTable() . '/videos/' . $this->image : \constPath::DefaultImage);
        }
    }
}
