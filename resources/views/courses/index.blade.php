...
@section('content')
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('Курсы')</li>
                            </ol>
                        </nav>
    ...
    <section id="courses-part" class="pt-40 pb-40 gray-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="courses-top-search">
                        <ul class="nav float-left" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">Поиск по курсам</li>
                        </ul> <!-- nav -->
...
{{--                                        </ul>--}}
{{--                                        <span>(20 Reviws)</span>--}}
                                            <a href="{{ route('courses.single', $course->id) }}">
                                                <h4>{{ $course->name }}</h4>
                                            </a>
